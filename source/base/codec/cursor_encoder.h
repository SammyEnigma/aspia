...
public:
    ...
    bool encode(const MouseCursor& mouse_cursor, proto::cursor::Shape* cursor_shape);

private:
    bool compressCursor(const MouseCursor& mouse_cursor, proto::cursor::Shape* cursor_shape) const;
