...
#ifndef CLIENT_UI_SYS_INFO_SYS_INFO_LICENSES_H
#define CLIENT_UI_SYS_INFO_SYS_INFO_LICENSES_H
...
public:
    explicit SysInfoWidgetLicenses(QWidget* parent = nullptr);
    ~SysInfoWidgetLicenses() final;
